...
if st.session_state.show_manual:
    with st.expander("📖 快速使用手册 (点击收起/展开)", expanded=True):
        ...
        2. **S16 任务机制**：如果目前你想要D4费卡，可以在你解锁了其中几张任务卡?这里填写目前通过任务解锁了几张4费卡，不需要填写其他费解锁的任务卡，如想D其他费卡，则同理。
        3. **S10 天选机制**：如你目前有天选，可以勾选我场上已经有天选/赛季之星了?，如果没有则无需勾选
        4. **场外干扰**：
           - **同行卡**：别人拿走了多少张你要的卡。
           - **其他同费卡**：别人拿走了别的4费卡（概率微升，帮你清了卡池）。
        5. **AI 教练**：可以选择用Deepseek深度思考还是快速响应，深度思考给出的结论可以更准确，快速响应适合做快速决定。
        6. **模拟报告**：点击开始模拟后会显示成功概率、预期花费和真实出卡率/格。
            - 成功概率：有多大几率可以D到你想要的牌
